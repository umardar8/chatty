...
const ContactsContainer = () => {
  return (
    <div className="relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] bg-[#1b1c24] border-[#2f303b] border-r-2 w-full">
      <div className="pt-3">
        <Logo />
      </div>
      <div className="my-5">
...
const Title = ({text}) => {
  return (
    <div className="uppercase tracking-widest text-neutral-400/90 pl-19 font-light text-sm">
      {text}
    </div>
  )
}